...
REDASH_SCHEDULER_CONTAINER_NAME := scheduler
...
$(DOCKER_COMPOSE_YAML): $(DOCKER_COMPOSE_YAML).erb Makefile $(DOCKER_COMPOSE)
	...
	REDASH_SCHEDULER_CONTAINER_NAME=$(REDASH_SCHEDULER_CONTAINER_NAME) \
	...
	REDASH_COOKIE_SECRET=$(REDASH_COOKIE_SECRET) REDASH_WORKERS_COUNT=$(REDASH_WORKERS_COUNT) MYSQL_PORT=$(MYSQL_PORT) PORT=$(PORT) \
	erb $< >$@
